						...
						<view class="register_view">
							<uni-forms class="form_register" :rules="rules" :value="form" ref="form"
								...
								<uni-forms-item class="user_group" name="user_group" label="身份">
									...
									<!-- 居民用户 -->
								<form_resident_users v-if="form.user_group === '居民用户'" @change="handleSubFormChange" :form="form_sub" ></form_resident_users>
...
<script>
	import mixin from "@/libs/mixins/page.js"
		/* 居民用户 */
	import form_resident_users from "@/components/diy/form_resident_users";
