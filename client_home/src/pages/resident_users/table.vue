<template>
  <view class="page_resident_users diy_table diy_table_tml" id="resident_users_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/resident_users/view?" v-show="user_group == '管理员' || $check_action('/resident_users/table','add') || $check_action('/resident_users/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/resident_users/table','del') || $check_action('/resident_users/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/resident_users/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/resident_users/table','set') || $check_action('/resident_users/view','set') || $check_action('/resident_users/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/resident_users/get_list?like=0",
				url_del: "~/api/resident_users/del?",
