					...
					<view>
						<view class="">
							<view  class="list_module">
									<view v-if="user_group != '管理员' && $check_action('/resident_users/table','get')">
									<navigator class="my_module" url="/pages/resident_users/table" hover-class="hover">
										<div>
											<text>居民用户</text>
											<span>></span>
										</div>
									...
									<navigator class="my_module" url="/pages/payment_information/table" hover-class="hover">
										...
										<view v-if="user_group != '管理员' && $check_action('/repair_request_information/table','get')">
									<navigator class="my_module" url="/pages/repair_request_information/table" hover-class="hover">
										<div>
											<text>报修信息</text>
											<span>></span>
										</div>
										...
										<view v-if="user_group != '管理员' && $check_action('/complaint_suggestions/table','get')">
									<navigator class="my_module" url="/pages/complaint_suggestions/table" hover-class="hover">
										<div>
											<text>投诉建议</text>
											<span>></span>
										</div>
